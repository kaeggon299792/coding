...
# 기존 코드의 의미와 저장값을 유지하면서 세밀한 감정 선택지를 확장한다.
_DIARY_MOODS.update({
    "delighted": ("😁", "매우 기쁨"),
    "cheerful": ("😃", "명랑함"),
    "joyful": ("😆", "즐거움"),
    ...
    "grounded": ("🌳", "마음이 단단함"),
    "patient": ("⏳", "인내심 있음"),
    "accepting": ("🌿", "있는 그대로 받아들임"),
    "gentle": ("🫧", "부드러운 기분"),
    "quiet": ("🤫", "조용히 있고 싶음"),
    "rested": ("🛌", "푹 쉼"),
    "clearheaded": ("🌬️", "머리가 맑음"),
    "nostalgic": ("📻", "그리움"),
    "sentimental": ("💌", "감상적임"),
    "dreamy": ("☁️", "몽글몽글함"),
    "reflective": ("🪞", "스스로 돌아봄"),
    ...
    "affectionate": ("💗", "애정이 넘침"),
    "romantic": ("🌹", "로맨틱함"),
    "connected": ("🤝", "연결되어 있다고 느낌"),
    "supported": ("🫶", "지지받음"),
    "trusting": ("🤍", "믿음이 생김"),
    "generous": ("🎁", "베풀고 싶음"),
    "kind": ("😇", "다정함"),
    "friendly": ("👋", "친근함"),
    "sociable": ("🗣️", "사람들과 어울리고 싶음"),
    "respected": ("🎖️", "존중받음"),
    "admired": ("👏", "인정받음"),
    "missing_someone": ("🥲", "누군가 보고 싶음"),
    "caring": ("🤲", "챙겨주고 싶음"),
    "touched": ("🥺", "감동함"),
    "warmhearted": ("🧡", "마음이 따뜻함"),
    "close": ("👭", "가까워진 느낌"),
    ...
    "thirsty": ("🥤", "목마름"),
    "caffeinated": ("☕", "카페인 충전됨"),
    "fresh_after_shower": ("🚿", "상쾌함"),
    "sore": ("🤕", "몸이 뻐근함"),
    "under_weather": ("🤒", "몸이 좋지 않음"),
    "lazy": ("🦥", "늘어짐"),
    "sluggish": ("🐌", "몸이 무거움"),
    "busy": ("🐝", "바쁨"),
    "rushed": ("🏃", "쫓기는 기분"),
...
_ARCHIVE_BOARDS = {
    "diary": {
        ...
        "list_kicker": "ARCHIVE",
        "list_title": "나의 기록",
        "empty_title": "아직 남긴 기록이 없습니다",
        "empty_description": "첫 일기를 작성해보세요.",
