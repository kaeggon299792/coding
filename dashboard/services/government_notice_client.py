...
def _date_iso(value):
    """Normalize API dates such as '2026. 5. 12.' to ISO format."""
...
def normalize_notice(node, matched_keyword):
    ...
    return {
        ...
        "announcement_date": _date_iso(_text(node, "pntcDt")),
        "start_date": _date_iso(_text(node, "stYd")),
        "end_date": _date_iso(_text(node, "edYd")),
